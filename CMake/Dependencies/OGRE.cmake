...
# Add Bullet Physics Libraries
set( OGRE_LIBRARIES
			${OGRE_LIBRARIES}
			"${OGRE_SOURCE}../bullet/bin/libBulletDynamics_gmake_x64_debug.a"
			"${OGRE_SOURCE}../bullet/bin/libBulletCollision_gmake_x64_debug.a"
			"${OGRE_SOURCE}../bullet/bin/libBullet3Common_gmake_x64_debug.a"
			"${OGRE_SOURCE}../bullet/bin/libLinearMath_gmake_x64_debug.a"
			optimized RenderSystem_Vulkan${OGRE_STATIC} )
...
set( OGRE_LIBRARIES
	...
	optimized ${OGRE_BINARIES}/lib/lib${OGRE_NEXT}HlmsPbs.so.3.0
	optimized ${OGRE_BINARIES}/lib/lib${OGRE_NEXT}HlmsUnlit.so.3.0
	optimized ${OGRE_BINARIES}/lib/lib${OGRE_NEXT}Overlay.so.3.0
	optimized ${OGRE_BINARIES}/lib/RenderSystem_Vulkan.so.3.0
	optimized ${OGRE_BINARIES}/lib/lib${OGRE_NEXT}Main.so.3.0

	debug ${OGRE_BINARIES}/lib/lib${OGRE_NEXT}HlmsPbs_d.so.3.0
	debug ${OGRE_BINARIES}/lib/lib${OGRE_NEXT}HlmsUnlit_d.so.3.0
	debug ${OGRE_BINARIES}/lib/lib${OGRE_NEXT}Overlay_d.so.3.0
	debug ${OGRE_BINARIES}/lib/RenderSystem_Vulkan_d.so.3.0
	debug ${OGRE_BINARIES}/lib/lib${OGRE_NEXT}Main_d.so.3.0
